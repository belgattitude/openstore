 ...
 */
class Language extends \Openstore\Entity\Language implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'inputFilter', 'id', 'lang', 'title', 'flag_active', 'flag_default', 'icon_class', 'created_at', 'updated_at', 'created_by', 'updated_by', 'legacy_mapping', 'legacy_synchro_at');
        }
    ...
    public function getFlagDefault()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getFlagDefault', array());

        return parent::getFlagDefault();
    }
    ...
    public function setFlagDefault($flag_default)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setFlagDefault', array($flag_default));

        return parent::setFlagDefault($flag_default);
    }
