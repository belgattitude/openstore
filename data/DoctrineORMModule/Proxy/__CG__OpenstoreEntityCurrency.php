 ...
 */
class Currency extends \Openstore\Entity\Currency implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'inputFilter', 'currency_id', 'reference', 'title', 'icon_class', 'created_at', 'updated_at', 'created_by', 'updated_by', 'legacy_mapping', 'legacy_synchro_at');
        }
    ...
    public function setCurrencyId($currency_id)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCurrencyId', array($currency_id));
