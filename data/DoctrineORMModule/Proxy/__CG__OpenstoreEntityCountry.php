 ...
 */
class Country extends \Openstore\Entity\Country implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'inputFilter', 'translations', 'country_id', 'reference', 'name', 'flag_active', 'icon_class', 'created_at', 'updated_at', 'created_by', 'updated_by', 'legacy_mapping', 'legacy_synchro_at');
        }
    ...
    public function setCountryId($country_id)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCountryId', array($country_id));

        return parent::setCountryId($country_id);
    }
