...
class Role extends \Openstore\Entity\Role implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'role_id', 'reference', 'parent_id');
        }
    ...
    public function setRoleId($reference)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setRoleId', array($reference));

        return parent::setRoleId($reference);
    }
     ...
     * {@inheritDoc}
     */
    public function setParent(\Openstore\Entity\Role $parent)
    {
