 ...
 */
class ProductBrand extends \Openstore\Entity\ProductBrand implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'inputFilter', 'translations', 'brand_id', 'reference', 'slug', 'title', 'description', 'url', 'flag_active', 'icon_class', 'created_at', 'updated_at', 'created_by', 'updated_by', 'legacy_mapping', 'legacy_synchro_at');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ProductBrand $proxy) {
