 ...
 */
class Pricelist extends \Openstore\Entity\Pricelist implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'inputFilter', 'translations', 'pricelist_id', 'stock_id', 'currency_id', 'reference', 'title', 'description', 'flag_active', 'new_product_min_date', 'icon_class', 'created_at', 'updated_at', 'created_by', 'updated_by', 'legacy_mapping', 'legacy_synchro_at');
        }
    ...
    public function setPricelistId($pricelist_id)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPricelistId', array($pricelist_id));

        return parent::setPricelistId($pricelist_id);
    }
    ...
    public function getPricelistId()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPricelistId', array());

        return parent::getPricelistId();
    }

    /**
     * {@inheritDoc}
     */
    public function setCurrency(\Openstore\Entity\Currency $currency_id)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCurrency', array($currency_id));

        return parent::setCurrency($currency_id);
    }
     ...
     * {@inheritDoc}
     */
    public function setStock(\Openstore\Entity\Stock $stock_id)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setStock', array($stock_id));

        return parent::setStock($stock_id);
    }
