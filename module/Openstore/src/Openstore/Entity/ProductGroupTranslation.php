 ...
 *     @ORM\UniqueConstraint(name="unique_translation_idx",columns={"group_id", "lang"})
 *   }, 
 *   indexes={
 *     @ORM\Index(name="title_idx", columns={"title"}),
 *     @ORM\Index(name="description_idx", columns={"description"}),
 *   },
 *   options={"comment" = "Product group translation table"}
 * )
 */
class ProductGroupTranslation implements InputFilterAwareInterface
{
	...
	/**
	 * 
     * @ORM\ManyToOne(targetEntity="ProductGroup", inversedBy="translations", cascade={"persist", "remove"})
     * @ORM\JoinColumn(name="group_id", referencedColumnName="group_id", onDelete="CASCADE", nullable=false)
	 */
	private $group_id;
