 ...
 *     @ORM\UniqueConstraint(name="unique_translation_idx",columns={"brand_id", "lang"})
 *   }, 
 *   indexes={
 ...
 * )
 */
class ProductBrandTranslation implements InputFilterAwareInterface
{
	...
	/**
	 * 
     * @ORM\ManyToOne(targetEntity="ProductBrand", inversedBy="translations", cascade={"persist", "remove"})
     * @ORM\JoinColumn(name="brand_id", referencedColumnName="brand_id", onDelete="CASCADE", nullable=false)
	 */
	private $brand_id;
